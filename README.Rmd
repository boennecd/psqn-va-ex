...
Laplace implementation in the `lme4` package. First we assign the seeds we will
use.
...
Next we set up the functions we will need to perform the simulation study.
